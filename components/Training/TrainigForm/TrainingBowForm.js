...
const TrainingBowForm = ({onSelectBow, navigation}) => {
 
  const dispatch = useDispatch();
  
  const [selectedText, setSelectedText] = useState('Классический лук без обвесов');
  ...
  return (
    ...
    >
      <View style ={styles.content }>
                <Ionicons name="close-sharp" size={24} color="black" onPress={() => onSelectBow("добавить лук")}/>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.row}>
            <Text style={styles.text}>Тип лука:</Text>
            <TextInput style={styles.InputText} value={selectedText} onChangeText={setSelectedText}  />
        </View>
        <View style={styles.row}>
...
export default TrainingBowForm;
